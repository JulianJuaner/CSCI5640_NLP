...
# 7. start training
trainer.train('resources/taggers/entity_shuf',
              learning_rate=0.1,
              mini_batch_size=32,
              write_weights=True,
              monitor_test=True,
...
plotter = Plotter()
plotter.plot_training_curves('resources/taggers/entity_shuf/loss.tsv')
plotter.plot_weights('resources/taggers/entity_shuf/weights.txt')